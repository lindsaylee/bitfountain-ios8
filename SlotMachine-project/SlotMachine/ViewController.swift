...
//  SlotMachine
//
//  Created by Lindsay Lee Siovaila on 10/22/14.
...
class ViewController: UIViewController {
    ...
    // Create containers that are type UIView and will initialize them later
    ...
    // Create constants that's accessible to entire project
    let kMarginForView:CGFloat = 10.0 //this is margin on left and right of screen
    ...
    func betOneButtonPressed (button: UIButton) {
        ...
        if credits <= 0 {
            ...
            if currentBet < 5 {
                ...
                showAlertWithText(message: "You can only bet 5 credits at  at a time")
            }
        }
    }
