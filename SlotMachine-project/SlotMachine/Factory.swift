...
//  SlotMachine
//
//  Created by Lindsay Lee Siovaila on 10/23/14.
...
class Factory {
    ...
    class func createSlots() -> [[Slot]] {
        ...
        // mySlotArray = slot[0] <--gives back slot1, slot2
        // slot = mySlotArray[1] <-- indexing into mySlotArray, returns slot2
    ...
    class func createSlot (currentCards:[Slot]) -> Slot {
        ...
        var randomNumber = Int(arc4random_uniform(UInt32(13))) // Numbers 0-12
        while contains(currentCardValues, randomNumber + 1){ // add 1 to each number because you want 1-13
